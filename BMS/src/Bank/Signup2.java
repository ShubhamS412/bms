    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t2.getText().equals("")){
                ...
                String regex1 = "[2-9]{1}[0-9]{3}\\s[0-9]{4}\\s[0-9]{4}";
                Pattern pattern1 = Pattern.compile(regex1);
                Matcher matcher1 = pattern1.matcher(aadhar);
            
                if(!matcher.matches()) {
                	JOptionPane.showMessageDialog(null, "Pan is incorrect");
                	new Signup2(formno).setVisible(false);
                	setVisible(true);
                }
                else if(!matcher1.matches()) {
                	JOptionPane.showMessageDialog(null, "Aadhar is incorrect");
                	new Signup2(formno).setVisible(false);
                	setVisible(true);
                }
                else { 
