        ...
        try{
            ...
            if(t6.getText().equals("")){
               ...
               // c1.s.executeUpdate(q1);
                ...
                String regex3 = "\\d+\\s+([a-zA-Z]+|[a-zA-Z]+\\s[a-zA-Z]+)";
                ...
                String regex5= "^[1-9]{1}[0-9]{2}{0}[0-9]{3}$?";
                Pattern pattern5 = Pattern.compile(regex5);
                Matcher matcher5 = pattern5.matcher(pincode);
                
               
                String regex6= "[a-zA-Z]+\\.?";
                Pattern pattern6 = Pattern.compile(regex6,Pattern.CASE_INSENSITIVE);
                Matcher matcher6 = pattern6.matcher(state);
                
                if(!matcher.matches()) {
                	JOptionPane.showMessageDialog(null, "Name is incorrect");
                	new Signup2(first).setVisible(false);
                	setVisible(true);
                }
                else if(!matcher1.matches()) {
                	JOptionPane.showMessageDialog(null, "FName is incorrect");
                	new Signup2(first).setVisible(false);
                	setVisible(true);
                }
                	...
                	JOptionPane.showMessageDialog(null, "Address is incorrect");
                	new Signup2(first).setVisible(false);
                	setVisible(true);
                }
                	...
                	JOptionPane.showMessageDialog(null, "Pincode is incorrect");
                	new Signup2(first).setVisible(false);
                	setVisible(true);
                }
                else if(!matcher6.matches()) {
                	JOptionPane.showMessageDialog(null, "State is incorrect");
                	new Signup2(first).setVisible(false);
                	setVisible(true);
                }
                else {
